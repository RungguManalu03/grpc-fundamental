...
type UserServiceClient interface {
	...
	ListUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserListResponse, error)
...
func (c *userServiceClient) ListUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	ListUser(context.Context, *Empty) (*UserListResponse, error)
...
func (UnimplementedUserServiceServer) ListUser(context.Context, *Empty) (*UserListResponse, error) {
